...
from modules.to_be import to_be_template, field_prediction, field4_prediction
import pandas as pd
...
def main(empresa):
    ...
    return template, vision_global, alcance,procesos_site, tareas_process, vision_global_fig, excel_charts, eficiencias_totales, field_predictions, field4_predictions
